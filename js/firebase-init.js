...
async function updateMenu(user) {
    ...
    const ham_ac = document.getElementById('hamberger-account-option');
    ...
    if (user) {
        ...
        try {
            ...
            if (userDoc.exists()) {
                ...
                logoutLi_ham.innerHTML = `<a href="#" id="hamlogoutButton">登出</a>`;
                ...
                const hamlogoutButton = document.getElementById('hamlogoutButton');
                if (logoutButton) {
                ...
                if (hamlogoutButton) {
                    hamlogoutButton.addEventListener('click', (e) => {
                        e.preventDefault();
                        auth.signOut()
                            .then(() => {
                                alert("登出成功！");
